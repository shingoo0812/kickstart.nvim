return {
  ...
  config = function()
    require('markview').setup {
      ...
      -- Additional configuration for vimwiki (if needed)
      buf_ignore = {}, -- Buffer patterns to ignore
    }
    ...
    -- Auto-enable for Markdown and vimwiki files
